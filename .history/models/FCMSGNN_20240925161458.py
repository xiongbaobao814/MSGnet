...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        A_input_ = self.nonlin_map(A_input)                                  # [1800, 18, 10]   [224, 18, 14] [448,512,8]
        A_input_ = torch.reshape(A_input_, [bs*scale_num*num_nodes, -1])     # [1800, 180]      [224, 252]    [448,4096]
        A_input_ = self.nonlin_map2(A_input_)                                # [1800, 32]       [224, 32]
        ...
        X_ = torch.transpose(X_, 1, 2)
        A_input_ = X_                                                # [100, 2, 9, 32]  [32, 1, 7, 32]
