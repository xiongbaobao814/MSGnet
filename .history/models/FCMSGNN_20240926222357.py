...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # 多尺度
        self.scaleset = ScaleGraphBlock(configs)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        scale_sizes, scale_nums = self.scaleset(x_enc)
        ...
        nonlin_map2 = nn.Linear(A_input_, self.lstmout_dim*self.conv_out, scale)
        A_input_ = nonlin_map2(A_input_)                                # [1800, 32]      [224, 32]     [448,32]
