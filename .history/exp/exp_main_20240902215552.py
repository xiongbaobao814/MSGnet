...
# in Python start with a hash symbol (#) and are used to provide explanations or notes within the code. 
# In this case, the comment appears to be indicating the name "MSGNet" for a section of code. 
