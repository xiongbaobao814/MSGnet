...
def data_provider(args, flag):
    ...
    # data_x:(34560, 7), data_y:(34560, 7), data_stamp:()

    batch_x_data = []
    batch_y_data = []
    batch_x_mark_data = []
    batch_y_mark_data = []
    for i, (batch_x, batch_y, data_stamp) in enumerate(data_set):
        batch_x_data.append(batch_x)
        # batch_y_data.append(batch_y)
        # batch_x_mark_data.append(batch_x_mark)
        # batch_y_mark_data.append(batch_y_mark)
        # print(batch_x_data, batch_y_data, batch_x_mark_data, batch_y_mark_data)
        print(batch_x.shape, batch_y.shape, data_stamp.shape, batch_y_mark.shape)
    print(i)
