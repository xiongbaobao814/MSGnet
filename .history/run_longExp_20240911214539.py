...
parser.add_argument('--moving_window', type=int, default=[2, 2], help='')
parser.add_argument('--stride', type=int, default=[1, 2], help='')
parser.add_argument('--decay', type=int, default=0.7, help='')
parser.add_argument('--pool_choice', type=int, default='mean', help='')
