...
parser.add_argument('--conv_out', type=int, default=32, help='')
parser.add_argument('--lstmhidden_dim', type=int, default=32, help='')
parser.add_argument('--lstmout_dim', type=int, default=32, help='')
parser.add_argument('--conv_kernel', type=int, default=32, help='')
parser.add_argument('--hidden_dim', type=int, default=32, help='')
parser.add_argument('--num_sensor', type=int, default=32, help='')
parser.add_argument('--num_windows', type=int, default=32, help='')
parser.add_argument('--moving_window', type=int, default=32, help='')
parser.add_argument('--stride', type=int, default=32, help='')
parser.add_argument('--decay', type=int, default=32, help='')
parser.add_argument('--pool_choice', type=int, default=32, help='')
parser.add_argument('--n_class', type=int, default=32, help='')
parser.add_argument('--time_denpen_len', type=int, default=32, help='')
